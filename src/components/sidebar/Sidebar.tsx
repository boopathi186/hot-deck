  ...
  return (
    <div className="sidebar bg-white h-100 vh-100 m-0 p-0 shadow">
      ...
      <div className="nav flex-column bg-white">
        <NavLink
          className="text-decoration-none nav-link fw-semibold d-flex align-items-center"
          to='/dashboard'
        >
          <i className="bi bi-speedometer2 me-2"></i> Dashboard
        </NavLink>
        <NavLink
          className="text-decoration-none  nav-link mt-4 fw-semibold d-flex align-items-center"
          to='/theme'
        >
